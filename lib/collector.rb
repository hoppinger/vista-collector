...
require './lib/collector/symfony/client'
require './lib/collector/symfony/command'
require './lib/collector/drupal/client'
require './lib/collector/drupal/command'
require './lib/collector/rails/client'
require './lib/collector/rails/command'
require './lib/collector/sinatra/client'
require './lib/collector/sinatra/command'
